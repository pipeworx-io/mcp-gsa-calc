...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/gsa_labor_rates \
  -H 'Content-Type: application/json' \
  -d '{"labor_category":"software engineer","min_experience":5}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/gsa_labor_rates`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
